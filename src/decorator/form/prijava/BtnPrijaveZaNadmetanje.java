 ...
 * @author Mladen
 */
public class BtnPrijaveZaNadmetanje extends DecoratorForm {
    public BtnPanel btnPanel;

    public BtnPrijaveZaNadmetanje(UnosForm unosForm) {
        super(unosForm);
        this.btnPanel = new BtnPanel("Prikaži prijave");
    }

    @Override
    public void setControler() {
        super.setControler();        
        new KontrolerBtnPrijaveZaNadmetanje(this);
    }
