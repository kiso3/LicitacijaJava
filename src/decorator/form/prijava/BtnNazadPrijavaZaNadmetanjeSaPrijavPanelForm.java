...
import kontroler.prijava.KontrolerBtnNazadPrijavaZaNadmetanjeSaPrijavPanelForm;
 ...
 * @author Mladen
 */
public class BtnNazadPrijavaZaNadmetanjeSaPrijavPanelForm extends DecoratorForm {
     public BtnPanel btnPanel;

    public BtnNazadPrijavaZaNadmetanjeSaPrijavPanelForm(UnosForm unosForm) {
        super(unosForm);
    ...
    public void setControler() {
        super.setControler();        
        new KontrolerBtnNazadPrijavaZaNadmetanjeSaPrijavPanelForm(this);
    }
