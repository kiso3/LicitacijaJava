...
import kontroler.prijava.KontrolerBtnPrijavaTableDodaj;
 ...
 * @author Mladen
 */
public class BtnPrijavaTableDodaj extends DecoratorForm  {
    public BtnPanel btnPanel;
    
    public BtnPrijavaTableDodaj(UnosForm unosForm) {
        super(unosForm);
    ...
    public void setControler() {
        super.setControler();        
        new KontrolerBtnPrijavaTableDodaj(this);
    }
